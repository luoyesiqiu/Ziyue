 ...
 */
public class EmojiconTextView extends TextView implements TextWatcher{
    ...
    private void updateText() {
        EmojiconHandler.addEmojis(getContext(), (Spannable) getText(), mEmojiconSize, mEmojiconAlignment, mEmojiconTextSize, mUseSystemDefault);
    }
    /**
